...
namespace JesseStiller.TerrainFormerExtension {
    internal class Shortcut {
        ...
        internal static readonly Dictionary<string, Shortcut> Shortcuts = new Shortcut[] {
            ...
            new Shortcut("Select Paint Texture Tool", "b"),
            new Shortcut("Select Shrinkwrap Tool", "n"),
            new Shortcut("Select Settings Tab", "m"),
        ...
        internal string BindingFormatted { get; private set; }
        ...
        internal void DoShortcutField() {
            ...
            switch(current.type) {
                ...
                case EventType.Repaint:
                    ...
                    GUI.skin.textField.Draw(keyFieldRect, new GUIContent(waitingForInput ? "Waiting for input…" : BindingFormatted), controlID);
                    break;
            }
        }
