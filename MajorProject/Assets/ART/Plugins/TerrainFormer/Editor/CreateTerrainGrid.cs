...
namespace JesseStiller.TerrainFormerExtension {
    public class CreateTerrainGrid : EditorWindow {
        ...
        void OnEnable() {
            ...
            terrainActiveTexture = AssetDatabase.LoadAssetAtPath<Texture2D>(TerrainFormerEditor.texturesDirectory + "TerrainActive.png");
            terrainInactiveTexture = AssetDatabase.LoadAssetAtPath<Texture2D>(TerrainFormerEditor.texturesDirectory + "TerrainInactive.png");
            arrowVerticalTexture = AssetDatabase.LoadAssetAtPath<Texture2D>(TerrainFormerEditor.texturesDirectory + "ArrowVertical.psd");
            arrowHorizontalTexture = AssetDatabase.LoadAssetAtPath<Texture2D>(TerrainFormerEditor.texturesDirectory +  "ArrowHorizontal.psd");
            mutedTextFieldFocusedTexture = AssetDatabase.LoadAssetAtPath<Texture2D>(TerrainFormerEditor.texturesDirectory + "MutedTextFieldFocused.psd");
        ...
        void OnGUI() {
            ...
            if(showTerrainSettings) {
                ...
                basemapResolution = Mathf.Clamp(
                    EditorGUILayout.IntPopup(TerrainSettings.basemapResolutionContent, basemapResolution, TerrainSettings.validTextureResolutionsContent, TerrainSettings.validTextureResolutions), 
                    0, 
                    2000);
            ...
            */
            ...
            GUILayout.FlexibleSpace();
            if(GUILayout.Button("Create…", GUILayout.Width(85f), GUILayout.Height(25f))) {
