...
Shader "Custom/TerrainMeshBlend/legacy Specular overlay" {
	Properties {
		...
		_TerrainShininess ("Terrain Shininess", Range (0.03, 1)) = 0.078125
	...
	CGPROGRAM
	#pragma surface surf BlinnPhong fullforwardshadows  vertex:vert alpha:blend exclude_path:prepass exclude_path:deferred
