...
{
	internal class TerrainBlendStandardShaderGUI : ShaderGUI
	{
		...
		private static class Styles
		{
			...
			//custom code
			public static GUIContent terrainAlbedoText = new GUIContent("Terrain Texture", "Terrain Texture");
			public static GUIContent terrainBumpText = new GUIContent("Terrain Normal Map", "Terrain Normals");
			public static GUIContent ColorCorrectionText = new GUIContent("Color Correction", "Color Correction");
			public static GUIContent terrainGlossinessText = new GUIContent("Terrain Shininess", "Shininess");
			public static GUIContent terrainMetallicText = new GUIContent("Terrain Metallic", "Metallic");
			public static GUIContent BlendText = new GUIContent("Blend Length", "Fade Length");
			public static GUIContent BlendOffsetText = new GUIContent("Blend Offset", "Add Height");
		...
		//edited
		MaterialProperty terrainalbedo = null;
		MaterialProperty terrainbump = null;
		MaterialProperty colorcorrection = null;
		MaterialProperty terrainglossiness = null;
		MaterialProperty terrainmetallic = null;
		MaterialProperty terrainblend = null;
		MaterialProperty terrainblendoffset = null;
